...
public class PrerequisitesManagement {
    ...
    public void addPrerequisite() throws SQLException {
    ...
    public void viewPrerequisitesByDeptAndCourse() throws SQLException {
        System.out.print("Enter Department Code: ");
        String deptCode = scanner.nextLine().trim();
        System.out.print("Enter Course Number: ");
    ...
    public  void deletePrerequisite() throws SQLException {
        System.out.print("Enter Department Code: ");
        String deptCode = scanner.nextLine().trim();
        System.out.print("Enter Course Number: ");
        String courseNum = scanner.nextLine().trim();
